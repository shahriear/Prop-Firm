      ...
      <div className="container ">
        <div className="text-center pt-8 flex flex-col  items-center">
          ...
          <p className="text-xl text-white font-medium pt-4 ">
            ...
            <br />
            <br />
            <span className="text-xl text-white font-semibold pt-4 ">
        ...
        <div className="flex flex-col justify-center items-center gap-7">
          <div className=" gap-7 px-32 pt-7 grid grid-cols-5 ">
          ...
          <div className="flex gap-7 px-80 items-center">
            <div className="border-2 rounded-md border-gray-500">
        ...
        {/* Schedule part */}
        <div className="pt-32">
          <div className="bg-blue-800/20  border border-gray-500 pt-14 pl-14 rounded-xl   hover:bg-gradient-to-bl from-blue-950 via-blue-950 to-indigo-600  relative overflow-hidden text-center mx-36 flex flex-col  items-center pb-16">
